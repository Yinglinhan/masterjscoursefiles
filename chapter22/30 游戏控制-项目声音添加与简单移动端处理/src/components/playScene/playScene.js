...
export default class PlayScene {
  constructor(app) {
    ...
    this.reStartBtnInstance = null

    this.gameOverTitleInstance = null
  ...
  gameStart() {
    ...
    this.reStartBtnInstance.hide()
    this.gameOverTitleInstance.hide()

    Control.BlockBarLife = 3
    Control.resetScore()
  }
  ...
  gameOver() {
    ...
    this.reStartBtnInstance.showUp()
    this.gameOverTitleInstance.showUp()
  }
  ...
  init() {
    ...
    const scoreText = new ScoreText({
      ...
      to: { x: this.app.screen.width / 2, y: this.app.screen.height - 75 }
    })
    ...
    this.gameOverTitleInstance = gameOverText
    this.sceneBox.addChild(gameOverText.element)
