...
// console.log(GameLoader.data)
await GameLoader.playSceneAssetsLoad()
...
const goldenStarTexture = await Assets.load('src/assets/elements/goldenStar.png')
...
const playScene = new PlayScene({ goldenStarTexture, barTexture, barCornerTexture, rainBowColorTexture, gameBlockTextTexture, chineseText, shapesBundle }, app)
